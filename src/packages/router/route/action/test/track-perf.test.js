...
describe('module "router/route/action"', () => {
  describe('enhancer trackPerf()', () => {
    ...
    it('works with actions', async () => {
      ...
      expect(stat.type).toBe('action');
      expect(stat.name).toBe('index');
      expect(stat.controller).toBe('PostsController');
    ...
    it('works with middleware', async () => {
      ...
      expect(stat.type).toBe('middleware');
      expect(stat.name).toBe('middleware');
      expect(stat.controller).toBe('PostsController');
    ...
    it('works with anonymous functions', async () => {
      ...
      expect(stat.type).toBe('middleware');
      expect(stat.name).toBe('anonymous');
      expect(stat.controller).toBe('PostsController');
